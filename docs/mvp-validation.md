...
当前机器运行 Windows 11，另有 Windows 10 22H2 虚拟机用于安装包、Win10 Light / Dark、布局边界和桌面交互回归。虚拟机不能替代多显示器、混合 DPI、触摸或全屏游戏等真实硬件覆盖，这些结论仍需分别记录。
...
```text
Release 全量测试 697/697 通过
匿名视觉契约定向测试 44/44 通过
公共仓库隐私扫描、研究材料迁移哈希核对和 git diff --check 通过
```
...
| 主题 | Win10/Win11 Light/Dark 资源、Acrylic、Popup Acrylic、对话框 Mica、Accent 解析和主题化控件状态具有自动测试 |
