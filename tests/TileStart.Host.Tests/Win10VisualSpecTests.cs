...
public sealed class Win10VisualSpecTests
{
    ...
    [Fact]
    public void DefaultTilesInheritTheMainSurfaceTextureWithoutAnIndependentNoiseLayer()
    {
        var document = LoadMainWindow();
        ...
        Assert.DoesNotContain(
            ...
            element => (string?)element.Attribute(x + "Name") == "TileNoiseOverlay"
                       || element.Name.LocalName == "WindowAlignedImageTile");
    }
